...
from wtforms.validators import DataRequired, Required #checks to make sure field isn't empty
...
class SetCreate(Form):
  ...
  set_winner_score = StringField('winner_score', validators=[DataRequired()])
  set_loser_score = StringField('loser_score', validators=[DataRequired()])

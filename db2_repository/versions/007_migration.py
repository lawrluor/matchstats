...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['set'].columns['tournament_relation'].drop()
    post_meta.tables['set'].columns['tournament'].create()
    post_meta.tables['set'].columns['tournament_name'].create()
    post_meta.tables['placement'].columns['tournament_name'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['set'].columns['tournament_relation'].create()
    post_meta.tables['set'].columns['tournament'].drop()
    post_meta.tables['set'].columns['tournament_name'].drop()
    post_meta.tables['placement'].columns['tournament_name'].drop()

...
sub_tournament = Table('sub_tournament', post_meta,
    ...
    Column('parent_tournament_id', Integer),
)
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['sub_tournament'].columns['parent_tournament_id'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['sub_tournament'].columns['parent_tournament_id'].drop()

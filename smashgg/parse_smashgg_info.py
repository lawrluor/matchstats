...
def parse_sub_bracket_info(sub_bracket_url):
	print "\n---SUB BRACKET URL---:", sub_bracket_url
...
def parse_tournament_info(tournament_id, tournament_name, region, date):
...
# Master function
def parse_bracket_info(tournament_url, tournament_name, region, date):
	...
	tournament_info = parse_tournament_info(tournament_id, tournament_name, region, date)
	tournament_obj = import_challonge_info(tournament_info, tournament_name, region, date)
	...
	# parse_sub_bracket_info(bracket_list[0]["url"])
	for sub_bracket in bracket_list:
		parse_sub_bracket_info(sub_bracket["url"])